...
import ModelGen3D.ImageToPCD as ITPCD
...
ds_points = (np.asarray(down_sampled_pcd.points)-down_sampled_pcd.get_center())* 10**5
...
orig_pcd.points = o3d.utility.Vector3dVector((np.asarray(orig_pcd.points)-orig_pcd.get_center())* 10**5)
...
plt.imsave(f"C:/WorkingSets/heightmap_{filename}", heightmap)
...
noisy_heightmap = np.where(enlarged_heightmap != 0, enlarged_heightmap, noisy_heightmap)
...
solution = np.where(enlarged_heightmap != 0, enlarged_heightmap, blured_noisy_heightmap)
...
projected_estimation_pcd_points[:, 0] = projected_estimation_pcd_points[:, 0] - reference_point[0]
projected_estimation_pcd_points[:, 2] = projected_estimation_pcd_points[:, 2] - reference_point[2]
projected_estimation_pcd.points = o3d.utility.Vector3dVector(projected_estimation_pcd_points)
projected_estimation_pcd_points = np.asarray(projected_estimation_pcd.points)
...
projected_estimation_pcd_points[:, 0] = projected_estimation_pcd_points[:, 0] - width_of_translation
projected_estimation_pcd_points[:, 2] = projected_estimation_pcd_points[:, 2] + depth_of_translation - depth_of_sheet
projected_estimation_pcd.points = o3d.utility.Vector3dVector(projected_estimation_pcd_points)
